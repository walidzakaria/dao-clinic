...
from chat.models import Chat, Rooms, Messages
from chat.serializers import ChatSerializer, MessageSerializer, ContactsSerializer
from chat.utils import hash_room
...
def active_rooms(request):
    if request.method == 'GET':
        ...
        query = f'''
            ...
            GROUP BY cc.room, cc.user_info, cc.user_id
